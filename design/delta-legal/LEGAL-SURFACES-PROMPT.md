...
| Name, email, session | Neon          | Signing you in and keeping you signed in.               |
...
single-row data table (`__Secure-neon-auth.session_token`, set by Neon Auth, strictly necessary — your
