...
| Search                | 3-input query bar + horizontal Refine bar, 4 col     | 3 col                               | **Drawn. 3 col** — 317.3px cards, 3:2 cover 211.5px. Refine stays **one row**; Sort is the only right-aligned item                       | Query bar keeps 3 inputs; Refine wraps to 2 rows, 2 col                                                                 | Query bar stacks to a 3-row card; sticky bottom "Filters · 3" + "Sort", 1 col                              |
...
| Checkout              | Form + 420px rail                                    | Same                                | **Drawn.** Rail 420 → **340px**; **Total today stays above the fold** — the hard constraint on this screen                               | Same, narrower                                                                                                          | Summary accordion above, total always visible                                                              |
...
- **Search** — 3 columns at the **16px** gutter, which is what 1440 and 768 both
  use: 317.3px cards, 3:2 cover 211.5px tall, and 152.4px of the second row
  visible at the 640 fold, which is the scroll affordance. Ruled 2026-09-04 (D30) — the
  14px/310px/207px figures this line used to carry came from the 1024 frame's own
  arithmetic, which disagreed with both neighbours.
- **Checkout** — the 340px rail must keep **Total today above the fold**. This is
