...
| `/account/settings`           | **Exempt — derived.** The account settings area (VEN-677, ruled by the account holder 2026-09-23): reached from `Account settings` in the account menu, for every role, the admin console's header included. Its one section today is Password — current, new and confirm — in frame `12`'s field and button vocabulary, the same basis `/reset-password` uses. Later settings join it as sections.                                                                   |
