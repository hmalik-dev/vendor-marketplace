...
| --------------- | -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Vendor type** | Plain select over the eleven categories, no typing | **Cannot hold an unrecognised value.** A click/tap list, no text input — eleven items is short enough to scan without type-to-filter (D43, 2026-09-22, superseding D28 for this control). It resolves to a category id or the field stays empty — never free text. |
