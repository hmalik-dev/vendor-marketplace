...
describe('drizzle snapshot parity', () => {
  ...
  const cases: readonly { readonly enumName: string; readonly values: readonly string[] }[] = [
    ...
    { enumName: 'backup_withholding_reason', values: BACKUP_WITHHOLDING_REASONS },
    ...
    { enumName: 'admin_alert_kind', values: ADMIN_ALERT_KINDS },
    { enumName: 'admin_alert_outcome', values: ADMIN_ALERT_OUTCOMES },
