...
export const DEMO_VENDORS: readonly DemoVendorSeed[] = [
  ...
  },
  {
    ...
    bio: 'Two-admin documentary coverage cut to a seven-minute film. Audio is recorded on three sources, because that is what ruins most wedding films.',
    city: 'Miami',
    state: 'FL',
    yearsInBusiness: 7,
    responseTimeHours: 9,
    ...
    packages: [
      pkg('feature', 'Feature Film', 'Full-day coverage cut to a seven-minute film.', 425000, {
        durationHours: '10.0',
        inclusions: ['Two admins', 'Seven-minute film', 'Three audio sources', 'Raw footage'],
      }),
      pkg('highlight', 'Highlight Reel', 'Six hours cut to a three-minute reel.', 265000, {
        durationHours: '6.0',
        inclusions: ['Two admins', 'Three-minute reel', 'Licensed music'],
      }),
