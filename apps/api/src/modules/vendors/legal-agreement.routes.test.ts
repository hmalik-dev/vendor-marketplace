...
describe('the vendor agreement', () => {
  ...
  describe('GET /vendor/agreement', () => {
    ...
    /** VEN-740: v1.3 replaces v1.0, so an agreement accepted at v1.0 no longer counts. */
    it('does not treat an agreement accepted at v1.0 as current, and asks for v1.3', async () => {
      await seedVendorProfile('vendor_a', 'June Harlow Photography');
      ...
      expect(CURRENT_VENDOR_AGREEMENT_VERSION).toBe('v1.3');
