...
You are responsible for what appears on your profile: the prices, the availability, the images and the description of what a customer receives. You confirm you hold the rights to every image you upload and that you are permitted to trade in the places you list.

## Accepting a booking

A request reaches you with a date, a price and a scope. It is live for {{requestExpiryDays}}; if you do not answer, it expires and nothing happens. Once you accept it, it is a contract between you and that customer for the date, price and scope shown on it.

## What the customer pays, and when you are paid

The customer pays {{brand}} at checkout, and {{brand}} holds the money until the event has happened. Your share is released {{payoutReleaseHours}} after the event date — a fixed window on the calendar, not something you or the customer can bring forward — and then travels to your bank at Stripe's own pace.
...
Payouts run through Stripe Connect. Stripe collects your bank details and enough identification to pay you legally; {{brand}} never sees them. You are bound by Stripe's own connected-account terms as well as this one.
...
You can unpublish your listing at any time. Bookings already accepted stand: the date is a commitment to a customer, not to the platform. {{brand}} can end this agreement where the law, a payment processor or a serious breach requires it.
