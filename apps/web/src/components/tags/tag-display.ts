...
/**
 * The three groups as chips in the search Refine bar, where the row has to fit
 * five controls plus Sort across 1440px. Frame `02` draws them as
 ...
 * glance on a vendor profile. One accent each, and `01-foundations.md` spends
 * colour on meaning: all three are a form of "can this vendor accommodate me".
 */
