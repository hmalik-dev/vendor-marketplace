...
| --- | --- | --- | --- |
| 1 | #203 | Stand up a **staging API service/environment on Railway**, `DATABASE_URL` on the `staging` branch | Railway |
| 1b | #203 | Point the staging web deploy's `API_URL` / `NEXT_PUBLIC_API_URL` at that service | Vercel env vars |
