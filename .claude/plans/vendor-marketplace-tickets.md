...
| **166** | **Availability calendar — every cell state carries a shape, not just a fill** | **P1** | **M3** | **P1 High** | **In Progress** | `worktree-166` | **None** | `core` | **Change order A1.** Booked/pending/blocked were within ~2 points of luminance — unreadable in greyscale or with CVD. Adds Completed + Today. Resolves #164. **Started 2026-08-29** in lane `worktree-166`; preflight `--ticket 166` passed 23/23 |
